...
//   
  ...
  int matchedCount = 0; //matchedCount indicates that we have matched all 4 muons appropriately, 2 to the Z, 2 to an UpsiN, and we have determined what that N is
   ...
   //trigger counters
int  firesTripleMuOnly2016 = 0;
int firesTripleMuOnly2017 = 0;
int firesTripleMuOnly2018 = 0;
 ...
 // double mu_mu_from_Z_Prob_Cut = 0.05; 
  ...
  TFile *ntuple = new TFile("firesTripleMuonOnly_2016Data.root", "RECREATE");
  TTree *aux;
...
std::cout << "firesTripleMuOnly2016:  " << firesTripleMuOnly2016 << std::endl;
std::cout << "firesTripleMuOnly2017:  " << firesTripleMuOnly2017 << std::endl;
std::cout << "firesTripleMuOnly2018:  " << firesTripleMuOnly2018 << std::endl;
