...
//   
 ...
 // double mu_mu_from_Z_Prob_Cut = 0.05; 
  ...
  TFile *ntuple = new TFile("cuts_inverted_study_for_Achim_2016.root", "RECREATE");
  TTree *aux;
...
//         // std::cout << (lepton1 + lepton2).M()<< std::endl; 
         ...
         if (Z_first_upsi_phase1_second_pair_12_34_56) {
            ...
            //// std::cout << "TREE->lepton1_isLooseMuon->at(i): " << TREE->lepton1_isLooseMuon->at(i) << std::endl;
         
           if (TREE->lepton1_isLooseMuon->at(i) + TREE->lepton2_isLooseMuon->at(i) != 2){  //both of them need to be tight, which has a value of 1, 1 +1 =2 
   ...
   //          }
      ...
      //      
         ...
         if  (upsi_phase1_first_Z_second_pair_12_34_56) { 
            ...
            if (TREE->lepton3_isLooseMuon->at(i) + TREE->lepton4_isLooseMuon->at(i) != 2){  //both of them need to be tight, which has a value of 1, 1 +1 =2 
               // std::cout << "AT LEAST ONE OF THE MUS FROM A Z WAS NOT TIGHT, FAILED THE Z->MU MU BOTH MU MOST BE TIGHT CUT" << std::endl;
               continue;
  ...
  //           for(int iEntry=0; iEntry<entriesMC; iEntry++) {
      ...
      if (TREE->pair_13_24_56->at(i) == 1){
         ...
         if (Z_first_upsi_phase1_second_pair_13_24_56){
            ...
            if (TREE->lepton1_isLooseMuon->at(i) + TREE->lepton3_isLooseMuon->at(i) != 2){  //both of them need to be tight, tight has a value of 1, 1 +1 =2 
               // std::cout << "AT LEAST ONE OF THE MUS FROM A Z WAS NOT TIGHT, FAILED THE Z->MU MU BOTH MU MOST BE TIGHT CUT" << std::endl;
               continue;
    ...
    //            if (TREEMC->mc_event_number->at(0) == evNumThisQuad && TREEMC->mc_run_number->at(0) == runNumThisQuad && TREEMC->mc_lumi_section->at(0) == LSThisQuad ){
         ...
         if (upsi_phase1_first_Z_second_pair_13_24_56) {
           ...
           //Z cuts
            ...
            if (TREE->lepton2_isLooseMuon->at(i) + TREE->lepton4_isLooseMuon->at(i) != 2){  //both of them need to be tight, tight has a value of 1, 1 +1 =2 
               // std::cout << "AT LEAST ONE OF THE MUS FROM A Z WAS NOT TIGHT, FAILED THE Z->MU MU BOTH MU MOST BE TIGHT CUT" << std::endl;
               continue;
      ...
      if (TREE->pair_14_23_56->at(i) == 1){
       //  // std::cout << "TREE->pair_14_23_56->at(i) == 1" << std::endl; 
         ...
         if (Z_first_upsi_phase1_second_pair_14_23_56){
            ...
            if (TREE->lepton1_isLooseMuon->at(i) + TREE->lepton4_isLooseMuon->at(i) != 2){  //both of them need to be tight, tight has a value of 1, 1 +1 =2 
               // std::cout << "AT LEAST ONE OF THE MUS FROM A Z WAS NOT TIGHT, FAILED THE Z->MU MU BOTH MU MOST BE TIGHT CUT" << std::endl;
               continue;
...
//                
         ...
         if (upsi_phase1_first_Z_second_pair_14_23_56) {
           // // std::cout << "PLACEHOLDER" << std::endl; 
             ...
             if (TREE->lepton2_isLooseMuon->at(i) + TREE->lepton3_isLooseMuon->at(i) != 2){  //both of them need to be tight, tight has a value of 1, 1 +1 =2 
               // std::cout << "AT LEAST ONE OF THE MUS FROM A Z WAS NOT TIGHT, FAILED THE Z->MU MU BOTH MU MOST BE TIGHT CUT" << std::endl;
               continue;
